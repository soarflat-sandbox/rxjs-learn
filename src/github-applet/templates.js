    ...
    <div class="repos_item_wrapper">
      <div class="repos_user_container">
        <div class="user_header_container">
          <img data-api="${owner.url}" class="user_header" src="${
    owner.avatar_url
  }"/>
      ...
      <div class="repos_info_container">
        ...
        <div class="repos_info">
          ...
          <i aria-hidden="true" class="fa fa-file-archive-o"></i>&nbsp;${formatRepoSizeAndUnit(
            repos.size
          ).join(' ')}
        </div>
      </div>
...
export const userTemplate = user => {
  ...
  <div class="infos_container">
    ...
    ${
      user.email
        ? `<a class="info_container" href="mailto:${user.email}">
      <div class="info_icon">
    ...
    ${
      user.blog
        ? `<a class="info_container" target="_blank" href="${user.blog}">
      <div class="info_icon">
    ...
    ${
      user.bio
        ? `<div class="info_container info_bio">
      <div class="info_icon">
